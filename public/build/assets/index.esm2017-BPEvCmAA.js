 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rr="firebase-messaging-database",$r=1,C="firebase-messaging-store";let q=null;function st(){return q||(q=$(Rr,$r,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(C)}}})),q}async function Pr(e){const t=at(e),r=await(await st()).transaction(C).objectStore(C).get(t);if(r)return r;{const o=await Mr(e.appConfig.senderId);if(o)return await ce(e,o),o}}async function ce(e,t){const n=at(e),o=(await st()).transaction(C,"readwrite");return await o.objectStore(C).put(t,n),await o.done,t}function at({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function no(e,t,n){const r=ro(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(r,{message_id:n[it],message_name:n[Dr],message_time:n[Cr],message_device_time:Math.floor(Date.now()/1e3)})}function ro(e){switch(e){case D.NOTIFICATION_CLICKED:return"notification_open";case D.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oo(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===D.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(De(n)):e.onMessageHandler.next(De(n)));const r=n.data;Jr(r)&&r[kr]==="1"&&await no(e,n.messageType,r)}const Ce="@firebase/messaging",ke="0.12.17";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function go(e=An()){return co().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),re(te(e),"messaging").getImmediate()}async function mo(e,t){return e=te(e),ut(e,t)}function bo(e,t){return e=te(e),uo(e,t)}ao();export{w as C,S as F,Rt as L,po as S,_,mo as a,ho as b,l as c,An as d,re as e,lo as f,go as g,G as h,Tn as i,fo as j,bo as o,b as r};
