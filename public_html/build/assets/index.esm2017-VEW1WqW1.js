 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function fo(e,t){if(e.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');const n={alg:"none",type:"JWT"},r=t||"demo-project",o=e.iat||0,i=e.sub||e.user_id;if(!i)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");const s=Object.assign({iss:`https://securetoken.google.com/${r}`,aud:r,iat:o,exp:o+3600,auth_time:o,sub:i,user_id:i,firebase:{sign_in_provider:"custom",identities:{}}},e);return[M(JSON.stringify(n)),M(JSON.stringify(s)),""].join(".")}function Re(){try{return typeof indexedDB=="object"}catch{return!1}}function $e(){return new Promise((e,t)=>{try{let n=!0;const r="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(r);o.onsuccess=()=>{o.result.close(),n||self.indexedDB.deleteDatabase(r),e(!0)},o.onupgradeneeded=()=>{n=!1},o.onerror=()=>{var i;t(((i=o.error)===null||i===void 0?void 0:i.message)||"")}}catch(n){t(n)}})}function Et(){return!(typeof navigator>"u"||!navigator.cookieEnabled)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const A=new Map,En=new Map,Z=new Map;function be(e,t){try{e.container.addComponent(t)}catch(n){g.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`,n)}}function _(e){const t=e.name;if(Z.has(t))return g.debug(`There were multiple attempts to register component ${t}.`),!1;Z.set(t,e);for(const n of A.values())be(n,e);for(const n of En.values())be(n,e);return!0}function re(e,t){const n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}function ho(e){return e==null?!1:e.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const po=In;function Tn(e,t={}){let n=e;typeof t!="object"&&(t={name:t});const r=Object.assign({name:Q,automaticDataCollectionEnabled:!1},t),o=r.name;if(typeof o!="string"||!o)throw m.create("bad-app-name",{appName:String(o)});if(n||(n=Be()),!n)throw m.create("no-options");const i=A.get(o);if(i){if(G(n,i.options)&&G(r,i.config))return i;throw m.create("duplicate-app",{appName:o})}const s=new kt(o);for(const c of Z.values())s.addComponent(c);const a=new Sn(n,r,s);return A.set(o,a),a}function An(e=Q){const t=A.get(e);if(!t&&e===Q&&Be())return Tn();if(!t)throw m.create("no-app",{appName:e});return t}function go(){return Array.from(A.values())}function b(e,t,n){var r;let o=(r=_n[e])!==null&&r!==void 0?r:e;n&&(o+=`-${n}`);const i=o.match(/\s|\//),s=t.match(/\s|\//);if(i||s){const a=[`Unable to register library "${o}" with version "${t}":`];i&&a.push(`library name "${o}" contains illegal characters (whitespace or "/")`),i&&s&&a.push("and"),s&&a.push(`version name "${t}" contains illegal characters (whitespace or "/")`),g.warn(a.join(" "));return}_(new w(`${o}-version`,()=>({library:o,version:t}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Dn="firebase-heartbeat-database",Cn=1,D="firebase-heartbeat-store";let V=null;function Le(){return V||(V=$(Dn,Cn,{upgrade:(e,t)=>{switch(t){case 0:try{e.createObjectStore(D)}catch(n){console.warn(n)}}}}).catch(e=>{throw m.create("idb-open",{originalErrorMessage:e.message})})),V}async function kn(e){try{const n=(await Le()).transaction(D),r=await n.objectStore(D).get(He(e));return await n.done,r}catch(t){if(t instanceof S)g.warn(t.message);else{const n=m.create("idb-get",{originalErrorMessage:t==null?void 0:t.message});g.warn(n.message)}}}async function we(e,t){try{const r=(await Le()).transaction(D,"readwrite");await r.objectStore(D).put(t,He(e)),await r.done}catch(n){if(n instanceof S)g.warn(n.message);else{const r=m.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});g.warn(r.message)}}}function He(e){return`${e.name}!${e.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pn(e){_(new w("platform-logger",t=>new Wt(t),"PRIVATE")),_(new w("heartbeat",t=>new Mn(t),"PRIVATE")),b(X,me,e),b(X,me,"esm2017"),b("fire-js","")}Pn("");var Fn="firebase",Ln="11.4.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */b(Fn,Ln,"app");const je="@firebase/installations",oe="0.6.13";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xe=1e4,Ve=`w:${oe}`,Ue="FIS_v2",Hn="https://firebaseinstallations.googleapis.com/v1",jn=60*60*1e3,xn="installations",Vn="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jn=/^[cdef][\w-]{21}$/,ee="";function Yn(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const n=Xn(e);return Jn.test(n)?n:ee}catch{return ee}}function Xn(e){return Gn(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tr="firebase-installations-database",nr=1,v="firebase-installations-store";let U=null;function ie(){return U||(U=$(tr,nr,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(v)}}})),U}async function B(e,t){const n=P(e),o=(await ie()).transaction(v,"readwrite"),i=o.objectStore(v),s=await i.get(n);return await i.put(t,n),await o.done,(!s||s.fid!==t.fid)&&Qe(e,t.fid),t}async function et(e){const t=P(e),r=(await ie()).transaction(v,"readwrite");await r.objectStore(v).delete(t),await r.done}async function F(e,t){const n=P(e),o=(await ie()).transaction(v,"readwrite"),i=o.objectStore(v),s=await i.get(n),a=t(s);return a===void 0?await i.delete(n):await i.put(a,n),await o.done,a&&(!s||s.fid!==a.fid)&&Qe(e,a.fid),a}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function se(e){let t;const n=await F(e.appConfig,r=>{const o=rr(r),i=or(e,o);return t=i.registrationPromise,i.installationEntry});return n.fid===ee?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function rr(e){const t=e||{fid:Yn(),registrationStatus:0};return tt(t)}function or(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(E.create("app-offline"));return{installationEntry:t,registrationPromise:o}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=ir(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:sr(e)}:{installationEntry:t}}async function ir(e,t){try{const n=await zn(e,t);return B(e.appConfig,n)}catch(n){throw Ke(n)&&n.customData.serverCode===409?await et(e.appConfig):await B(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function sr(e){let t=await _e(e.appConfig);for(;t.registrationStatus===1;)await Ye(100),t=await _e(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await se(e);return r||n}return t}function _e(e){return F(e,t=>{if(!t)throw E.create("installation-not-found");return tt(t)})}function tt(e){return ar(e)?{fid:e.fid,registrationStatus:0}:e}function ar(e){return e.registrationStatus===1&&e.registrationTime+xe<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function cr({appConfig:e,heartbeatServiceProvider:t},n){const r=ur(e,n),o=Kn(e,n),i=t.getImmediate({optional:!0});if(i){const d=await i.getHeartbeatsHeader();d&&o.append("x-firebase-client",d)}const s={installation:{sdkVersion:Ve,appId:e.appId}},a={method:"POST",headers:o,body:JSON.stringify(s)},c=await Je(()=>fetch(r,a));if(c.ok){const d=await c.json();return qe(d)}else throw await ze("Generate Auth Token",c)}function ur(e,{fid:t}){return`${We(e)}/${t}/authTokens:generate`}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ae(e,t=!1){let n;const r=await F(e.appConfig,i=>{if(!nt(i))throw E.create("not-registered");const s=i.authToken;if(!t&&fr(s))return i;if(s.requestStatus===1)return n=dr(e,t),i;{if(!navigator.onLine)throw E.create("app-offline");const a=pr(i);return n=lr(e,a),a}});return n?await n:r.authToken}async function dr(e,t){let n=await Ee(e.appConfig);for(;n.authToken.requestStatus===1;)await Ye(100),n=await Ee(e.appConfig);const r=n.authToken;return r.requestStatus===0?ae(e,t):r}function Ee(e){return F(e,t=>{if(!nt(t))throw E.create("not-registered");const n=t.authToken;return gr(n)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function lr(e,t){try{const n=await cr(e,t),r=Object.assign(Object.assign({},t),{authToken:n});return await B(e.appConfig,r),n}catch(n){if(Ke(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await et(e.appConfig);else{const r=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await B(e.appConfig,r)}throw n}}function nt(e){return e!==void 0&&e.registrationStatus===2}function fr(e){return e.requestStatus===2&&!hr(e)}function hr(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+jn}function pr(e){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}function gr(e){return e.requestStatus===1&&e.requestTime+xe<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yr(e){if(!e||!e.options)throw K("App Configuration");if(!e.name)throw K("App Name");const t=["projectId","apiKey","appId"];for(const n of t)if(!e.options[n])throw K(n);return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}function K(e){return E.create("missing-app-config-values",{valueName:e})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rt="installations",Ir="installations-internal",_r=e=>{const t=e.getProvider("app").getImmediate(),n=yr(t),r=re(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Er=e=>{const t=e.getProvider("app").getImmediate(),n=re(t,rt).getImmediate();return{getId:()=>mr(n),getToken:o=>br(n,o)}};function vr(){_(new w(rt,_r,"PUBLIC")),_(new w(Ir,Er,"PRIVATE"))}vr();b(je,oe);b(je,oe,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sr="/firebase-messaging-sw.js",Tr="/firebase-cloud-messaging-push-scope",ot="BDOU99-h67HcA6JeFXHbSNMu7e2yNNu3RzoMj8TM4W88jITfq7ZmPvIM1Iv-4_l2LxQcYwhqby2xGpWwzjfAnG4",Ar="https://fcmregistrations.googleapis.com/v1",it="google.c.a.c_id",Dr="google.c.a.c_l",Cr="google.c.a.ts",kr="google.c.a.e",ve=1e4;var Se;(function(e){e[e.DATA_MESSAGE=1]="DATA_MESSAGE",e[e.DISPLAY_NOTIFICATION=3]="DISPLAY_NOTIFICATION"})(Se||(Se={}));/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function h(e){const t=new Uint8Array(e);return btoa(String.fromCharCode(...t)).replace(/=/g,"").replace(/\+/g,"-").replace(/\//g,"_")}function Or(e){const t="=".repeat((4-e.length%4)%4),n=(e+t).replace(/\-/g,"+").replace(/_/g,"/"),r=atob(n),o=new Uint8Array(r.length);for(let i=0;i<r.length;++i)o[i]=r.charCodeAt(i);return o}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rr="firebase-messaging-database",$r=1,k="firebase-messaging-store";let q=null;function st(){return q||(q=$(Rr,$r,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(k)}}})),q}async function Pr(e){const t=at(e),r=await(await st()).transaction(k).objectStore(k).get(t);if(r)return r;{const o=await Mr(e.appConfig.senderId);if(o)return await ce(e,o),o}}async function ce(e,t){const n=at(e),o=(await st()).transaction(k,"readwrite");return await o.objectStore(k).put(t,n),await o.done,t}function at({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const xr=7*24*60*60*1e3;async function Vr(e){const t=await Kr(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:h(t.getKey("auth")),p256dh:h(t.getKey("p256dh"))},r=await Pr(e.firebaseDependencies);if(r){if(Wr(r.subscriptionOptions,n))return Date.now()>=r.createTime+xr?Ur(e,{token:r.token,createTime:Date.now(),subscriptionOptions:n}):r.token;try{await jr(e.firebaseDependencies,r.token)}catch(o){console.warn(o)}return Ae(e.firebaseDependencies,n)}else return Ae(e.firebaseDependencies,n)}async function Ur(e,t){try{const n=await Hr(e.firebaseDependencies,t),r=Object.assign(Object.assign({},t),{token:n,createTime:Date.now()});return await ce(e.firebaseDependencies,r),n}catch(n){throw n}}async function Ae(e,t){const r={token:await Lr(e,t),createTime:Date.now(),subscriptionOptions:t};return await ce(e,r),r.token}async function Kr(e,t){const n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:Or(t)})}function Wr(e,t){const n=t.vapidKey===e.vapidKey,r=t.endpoint===e.endpoint,o=t.auth===e.auth,i=t.p256dh===e.p256dh;return n&&r&&o&&i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Jr(e){return typeof e=="object"&&!!e&&it in e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Qr(e){try{e.swRegistration=await navigator.serviceWorker.register(Sr,{scope:Tr}),e.swRegistration.update().catch(()=>{}),await Zr(e.swRegistration)}catch(t){throw f.create("failed-service-worker-registration",{browserErrorMessage:t==null?void 0:t.message})}}async function Zr(e){return new Promise((t,n)=>{const r=setTimeout(()=>n(new Error(`Service worker not registered after ${ve} ms`)),ve),o=e.installing||e.waiting;e.active?(clearTimeout(r),t()):o?o.onstatechange=i=>{var s;((s=i.target)===null||s===void 0?void 0:s.state)==="activated"&&(o.onstatechange=null,clearTimeout(r),t())}:(clearTimeout(r),n(new Error("No incoming service worker found.")))})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eo(e,t){if(!t&&!e.swRegistration&&await Qr(e),!(!t&&e.swRegistration)){if(!(t instanceof ServiceWorkerRegistration))throw f.create("invalid-sw-registration");e.swRegistration=t}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function to(e,t){t?e.vapidKey=t:e.vapidKey||(e.vapidKey=ot)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ut(e,t){if(!navigator)throw f.create("only-available-in-window");if(Notification.permission==="default"&&await Notification.requestPermission(),Notification.permission!=="granted")throw f.create("permission-blocked");return await to(e,t==null?void 0:t.vapidKey),await eo(e,t==null?void 0:t.serviceWorkerRegistration),Vr(e)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function no(e,t,n){const r=ro(t);(await e.firebaseDependencies.analyticsProvider.get()).logEvent(r,{message_id:n[it],message_name:n[Dr],message_time:n[Cr],message_device_time:Math.floor(Date.now()/1e3)})}function ro(e){switch(e){case C.NOTIFICATION_CLICKED:return"notification_open";case C.PUSH_RECEIVED:return"notification_foreground";default:throw new Error}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oo(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===C.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(De(n)):e.onMessageHandler.next(De(n)));const r=n.data;Jr(r)&&r[kr]==="1"&&await no(e,n.messageType,r)}const Ce="@firebase/messaging",ke="0.12.17";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const io=e=>{const t=new Xr(e.getProvider("app").getImmediate(),e.getProvider("installations-internal").getImmediate(),e.getProvider("analytics-internal"));return navigator.serviceWorker.addEventListener("message",n=>oo(t,n)),t},so=e=>{const t=e.getProvider("messaging").getImmediate();return{getToken:r=>ut(t,r)}};function ao(){_(new w("messaging",io,"PUBLIC")),_(new w("messaging-internal",so,"PRIVATE")),b(Ce,ke),b(Ce,ke,"esm2017")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function co(){try{await $e()}catch{return!1}return typeof window<"u"&&Re()&&Et()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function mo(e=An()){return co().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),re(te(e),"messaging").getImmediate()}async function bo(e,t){return e=te(e),ut(e,t)}function wo(e,t){return e=te(e),uo(e,t)}ao();export{w as C,S as F,Rt as L,po as S,_,bo as a,go as b,An as c,ho as d,l as e,re as f,mo as g,lo as h,Tn as i,G as j,fo as k,wo as o,b as r};
